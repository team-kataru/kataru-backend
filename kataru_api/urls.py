...
urlpatterns = [
    ...
    path('users/<int:user_id>/stories/', views.user_stories, name='user_stories'),
    path('users/<int:user_id>/stories/<int:story_id>/', views.user_stories_id, name='user_stories_id'),
